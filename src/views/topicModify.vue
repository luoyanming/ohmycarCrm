        ...
        <div class="container-wrapper">
            ...
            <div class="main-wrapper yzb light-overscroll">
                <section class="crumbs">
                    <el-breadcrumb separator="/" v-if="!add">
                ...
                <section class="formation" v-if="!add">
                    <el-form ref="ruleForm" :label-position="labelPosition" label-width="80px" :model="form">
                        <el-form-item label="专题名称" v-if="id">
                            <div class="form-content">
                                <p class="text">{{ formList.name }}</p>
                            </div>
                        </el-form-item>
                        <el-form-item label="专题图片" v-if="id">
                            <div class="form-content">
                                <img :src="formList.picUrl">
                            </div>
                        </el-form-item>
                     ...
                     <section id="topicDynamic">
                        <el-table :data="tableList" stripe style="width: 100%" v-loading="tableloading">
                            ...
                            <el-table-column label="操作">
                                <template scope="scope">
                                        <!-- <el-checkbox :checked="scope.row.checked" @click.native="addClick(scope.$index,scope.row)"></el-checkbox> -->
...
<script>
    import {BASE,topicDetail, topicMomentRemove,topicMomentList,topicAddMoment} from '../api/api';
            ...
            getTopicDetails() {
                ...
                topicDetail(param).then(res =>{
                    ...
                    if(code !== 0){
                        ...
                        this.formList.picUrl = data.detail.picUrl;
