    ...
    <div class="app-container">
        <div class="container-wrapper">
            ...
            <section class="login-wrap">
                <div class="login-box">
                    <div class="logo"></div>
                    <h1 class="title">偶滴车CRM管理后台</h1>

                    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0" class="demo-ruleForm">
                        <el-form-item prop="account">
                            <el-input v-model="ruleForm.account" auto-complete="off" placeholder="请输入手机号"></el-input>
                        </el-form-item>
    ...
    .login-wrap{
        ...
        .login-box{
            ...
            .logo{
                ...
                width: 236px;
                height: 118px;
                background-image: url('/static/icon_BG_logo.png');
