                        ...
                        <el-table-column label="操作">
                            <template scope="scope">
                                ...
                                <el-button size="small" class="button-link" @click="handleEdit(scope.$index, scope.row)">编辑</el-button>
                                 <el-button size="small" class="button-link" @click="handleFreeze(scope.$index, scope.row)" v-if="scope.row.status == 0">隐藏</el-button>
                                <el-button size="small" class="button-link color-orange" @click="handleUnFreeze(scope.$index, scope.row)" v-if="scope.row.status == -1">取消隐藏</el-button>
